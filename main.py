...
total_score = 0
current_level = 7
ball_remain = 1000000000000000000000000000
progress_bar = {
    'x': 40,
    'y': 40,
    'width': 1300,
...
level_configs = [
    ...
    {'target_score': 1, 'init_white_balls': 1000000000000000000000000000, 'color_ball_count': 1},
    {'target_score': 5, 'init_white_balls': 1000000000000000000000000000, 'color_ball_count': 2},
    {'target_score': 3, 'init_white_balls': 1000000000000000000000000000, 'color_ball_count': 3},
    {'target_score': 2, 'init_white_balls': 1000000000000000000000000000, 'color_ball_count': 4},
    {'target_score': 2, 'init_white_balls': 1000000000000000000000000000, 'color_ball_count': 5},
    {'target_score': 10, 'init_white_balls': 1000000000000000000000000000, 'color_ball_count': 6},
    {'target_score': 1, 'init_white_balls': 1000000000000000000000000000, 'color_ball_count': 7},
    {'target_score': 1, 'init_white_balls': 1000000000000000000000000000, 'color_ball_count': 8},
    {'target_score': 14, 'init_white_balls': 1000000000000000000000000000, 'color_ball_count': 9},
    {'target_score': 10000, 'init_white_balls': 1000000000000000000000000000, 'color_ball_count': 10}
]
...
def init_level(level):
    ...
    global ghost_ball, speedup_active, speedup_timer, spark_particles, progress_bar, trail_particles, balls
...
while running:
    for event in pygame.event.get():
        ...
        if event.type == pygame.MOUSEBUTTONDOWN and event.button == 1:
            ...
            # 优先检测KK按钮点击
            if kk_button_rect.collidepoint(click_x, click_y):
                reward_random_item()
                continue
